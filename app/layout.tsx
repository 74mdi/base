...
const siteDescription =
  'A clean base to scope, plan, and launch new projects with focus.'
...
(() => {
  try {
    ...
    const storedMode = window.localStorage.getItem('base-theme-mode');
...
(() => {
  const reloadKey = 'base-chunk-reload-once';
      ...
      >
        ...
        <div className='flex flex-col mobile:flex-row'>
          ...
          <main className='relative flex-1 max-w-2xl [contain:inline-size]'>
            <div className='sidebar-divider absolute w-full h-px opacity-50 bg-rurikon-border right-0 mobile:right-auto mobile:left-0 mobile:w-px mobile:h-full mobile:opacity-100' />
